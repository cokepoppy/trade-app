...
| 登录界面 | 主界面 | 我的页面 |
|---------|--------|---------|
| ![登录界面](images/login.png) | ![主界面](images/main.png) | ![我的页面](images/my.png) |

### 交易功能
| 选股界面 | 买入界面 | 委托管理 |
|---------|--------|---------|
| ![选股界面](images/selectstock.png) | ![买入界面](images/buy.png) | ![委托管理](images/weituo.png) |

### 账户管理
| 持仓查询 | 资金管理 | 自选股 |
|---------|--------|---------|
| ![持仓查询](images/holding.png) | ![资金管理](images/money.png) | ![自选股](images/selfstock.png) |

### 交易记录
| 成交记录 | 新闻资讯 |
|---------|--------|
| ![成交记录](images/trade.png) | ![新闻资讯](images/news.png) |
